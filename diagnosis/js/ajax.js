...
$(function(){	
	...
	$('#btn-result').on('click', function(){
		...
		var result_string = "";
		if (diagnosis_score > 51) {
			result_string = "Anda telah didiagnosa mengidap penyakit malaria Berat.Periksa Ke Dokter Segera";
		} else if (diagnosis_score > 19 && diagnosis_score < 50) {
			result_string = "Anda telah didiagnosa dengan Malaria Ringan .Periksa Ke Dokter Segera";
		} else if (diagnosis_score < 20){
			result_string = "Anda Bebas dari malaria";
		}
		$('#btn-result').addClass("hide").removeClass("show");
